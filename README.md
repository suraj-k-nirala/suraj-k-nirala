...
I build end-to-end data solutions using Python, SQL, Power BI, Apache Spark, Airflow, Kafka, and AWS. I enjoy designing scalable batch and real-time data pipelines, transforming raw data into actionable insights, and creating analytics dashboards that support business decisions.
...
**Tech Stack:** AWS Lambda • AWS Glue • Amazon S3 • Amazon Athena • Apache Airflow • Docker • Terraform • Python

### Key Highlights

- Built a serverless real-time stock market data pipeline using AWS Lambda for automated data ingestion.
- Implemented a Medallion Architecture (Bronze, Silver, Gold) on Amazon S3 for scalable data storage and transformation.
- Automated ETL workflows using AWS Glue for data cleansing and enrichment.
- Enabled high-performance analytical queries with Amazon Athena over the data lake.
- Provisioned cloud infrastructure using Terraform for repeatable and infrastructure-as-code deployments.
